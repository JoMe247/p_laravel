    ...
    <body>
        ...
        <div class="container" style="display: none;">
            ...
            <div class="container-drag" id="draggable-area" style="display: none;">
                <div class="box" contenteditable="true" id="dragged-value" spellcheck="false" data-icon="text">Add
                    Text
                </div>
            </div>
        ...
        <div id="options-bar" style="display: none;">
            ...
            <div class="option-item" onclick="phoneActive()">
                <i class='bx bx-phone'></i>
                <p class="option-info">
                    This will place the customer phone dynamically when sending.
                </p>
            </div>

            <div class="option-item" onclick="policyActive()">
                <i class='bx bx-file'></i>
                <p class="option-info">
                    This will place the policy number dynamically when sending.
                </p>
            </div>
