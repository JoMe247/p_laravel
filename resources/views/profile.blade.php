                        ...
                        <div class="profile-card-container">
                            ...
                            <div class="profile-photo-section">
                                <div class="profile-photo-top">
                                    ...
                                    <button id="view-profile-log-btn" class="btn profile-view-log-btn"
                                        type="button">
                            ...
                            <form id="profile-form" method="POST"
                                ...
                                <div class="profile-actions">
                                    <a id="profile-back" href="{{ route('customers.index') }}"
                                        class="btn secondary"><i class='bx bx-arrow-back'></i></a>
