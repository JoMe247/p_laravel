    ...
    <body>
                    ...
                    <div class="documents-topbar">
                        <div class="documents-actions">
                            ...
                            <div class="print-dropdown">
                                ...
                                <div id="print-documents-menu" class="print-documents-menu hidden"></div>
                            </div>
                        </div>
                                        ...
                                        @foreach ($documents as $doc)
                                            ...
                                            <tr>
                                                ...
                                                <td class="td-tools">
                                                    ...
                                                    <button type="button"
                                                        class="tool-btn tool-danger btn-delete-document" title="Delete"
                                                        data-doc-id="{{ $doc->id }}">
        ...
        <script>
            window.documentsRoutes = {
                ...
                templateFile: "{{ route('documents.templates.file', ':id') }}"
            };
