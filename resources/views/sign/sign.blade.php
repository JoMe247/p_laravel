...
<body onselectstart="return false">
  ...
  <div class="document-information" style="padding:0; overflow:hidden;">
      <iframe
        src="{{ route('sign.pdf', ['short' => $short, 'docId' => $docId]) }}"
  ...
  <div id="signature-pad" class="signature-pad">
    ...
    <div class="signature-pad--footer">
      <div class="signature-pad--actions">
        <div>
          <button type="button" class="button clear" id="clear"><p class="icon-trash">Clear</p></button>
          <button type="button" class="button" id="undo"><p class="icon-ccw">Undo</p></button>
        </div>

        <div style="display:block;margin-left:auto;margin-right:auto;">
          <button type="button" class="button save" id="firmar"><p class="icon-pencil">Sign</p></button>
