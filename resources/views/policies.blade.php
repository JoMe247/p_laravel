                        ...
                        <div id="policy-log-text">
                            @forelse($policyLog as $log)
                                ...
                                <div class="policy-log-entry">
                                    ...
                                    <strong>EffDate:</strong> {{ $snapshot['pol_eff_date'] ?? '-' }},
                                    <strong>ExpDate:</strong> {{ $snapshot['pol_expiration'] ?? '-' }},
                                    <strong>PayDate:</strong> {{ $snapshot['pol_due_day'] ?? '-' }},
                                    <strong>Carrier:</strong> {{ $snapshot['pol_carrier'] ?? '-' }},
                                    <strong>URL:</strong> {{ $snapshot['pol_url'] ?? '-' }},
                                    <strong>Agent Record:</strong> {{ $snapshot['pol_agent_record'] ?? '-' }},
                                    <strong>Changed Fields:</strong> {{ $log['changed_fields_text'] ?? '-' }},
                                    <strong>Vehicles:</strong> {{ $log['vehicles_text'] ?? '-' }},
                                    <strong>Vehicle Changes:</strong> {{ $log['vehicle_changes_text'] ?? '-' }}
                                </div>
                            @empty
