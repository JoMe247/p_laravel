...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/sms-inbox.css') }}"><!-- 👈 tu nuevo CSS -->
                        ...
                        <div class="sms-app">
                            ...
                            <div class="sms-list">
                                <div class="top-actions">
                                    <button id="btnSync" class="btn secondary">Sincronizar</button>
                                ...
                                <div id="contacts">
                                    @forelse ($contacts as $c)
                                        <div class="sms-contact" data-contact="{{ $c['contact'] }}">
                                            <input type="checkbox" class="contact-check" value="{{ $c['contact'] }}" style="margin-right:8px;">
                                            ...
                                            <button class="btn danger btnDeleteOne" data-contact="{{ $c['contact'] }}" style="padding:4px 8px;">🗑</button>
                                        </div>
                                    @empty
                                        <div class="empty">No hay conversaciones. Presiona <strong>Sincronizar</strong> para leer mensajes desde Twilio.</div>
                                    @endforelse
                                </div>
                            </div>
                            ...
                            <div class="sms-chat">
                                ...
                                <div class="composer" id="composer" style="display:none;">
                                    <form id="sendForm" style="display:flex;width:100%;gap:8px;">
                                        @csrf
